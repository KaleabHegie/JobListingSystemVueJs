      ...
      <section class="relative bg-gray-500 overflow-hidden">
        <div class="max-w-7xl mx-auto py-14 px-6 lg:px-8">
          <div class="flex justify-center">
            <h1 class="text-10xl tracking-tight text-white text-center sm:text-4xl">BookmarkedJobs Jobs</h1>
          </div>
        </div>
      </section>
    </div>
          ...
          <div class="table-responsive bg-white shadow-md rounded-lg">
            <table class="table table-auto w-full">
              ...
              <tbody class="bg-white">
                ...
                <tr v-if="!profileStore.loading && profileStore.bookmarkedJobs.length === 0">
