      ...
      <div class="sm:w-full sm:max-w-lg flex-1">
        ...
        <form class="space-y-6" action="#" method="POST">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <!-- Username -->
                <div>
                    <label for="user-name" class="block text-sm font-medium text-gray-900">Username</label>
                    <input id="user-name" name="user-name" type="text" required placeholder="Choose a username" 
                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>
            
                <!-- Date of Birth -->
                <div>
                    <label for="date-of-birth" class="block text-sm font-medium text-gray-900">Date of Birth</label>
                ...
                <div>
                    ...
                    <input id="address" name="address" type="text" required placeholder="Enter your address" 
                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>
                ...
                <div>
                    ...
                    <input id="city" name="city" type="text" required placeholder="Enter your city" 
                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>
                ...
                <div>
                    ...
                    <input id="country" name="country" type="text" required placeholder="Enter your country" 
                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm">
                </div>
